  ...
  return (
    <div className="terms-page">
      ...
      <div className="card terms-card">
        ...
        <section>
          <h2>제3조의2 (이용자가 작성한 꿈 내용)</h2>
          <p>
            이용자가 &lsquo;꿈 물어보기&rsquo;에 작성한 꿈 내용과 이에 대한 풀이는 사이트에
            공개되며, 다른 이용자의 열람과 검색엔진 색인에 노출될 수 있습니다. 이용자는 타인의
            개인정보, 명예를 훼손하는 내용, 음란·폭력적인 내용을 작성해서는 안 되며, 운영자는
            이러한 내용을 사전 통지 없이 삭제하거나 공개하지 않을 수 있습니다. 풀이는 자동으로
            생성되는 참고용 정보이며, 그 내용의 정확성이나 결과에 대해 운영자는 책임을 지지 않습니다.
          </p>
        </section>
