    ...
    <div className="privacy-page">
      ...
      <div className="card privacy-card">
        ...
        <section>
          <h2>2. 수집하는 개인정보</h2>
          <p>
            본 사이트는 회원가입이나 댓글 기능을 제공하지 않으며, 이름·이메일·연락처 등{" "}
            <strong>개인정보를 직접 수집하지 않습니다</strong>.
          </p>
          <p>
            다만 &lsquo;꿈 물어보기&rsquo; 기능으로 이용자가 적은 꿈 내용과 그 풀이는{" "}
            <strong>사이트에 공개</strong>되어 다른 방문자가 볼 수 있습니다. 꿈 내용에는
            이름·연락처 등 개인정보를 적지 마시기 바라며, 전화번호·이메일·링크가 포함된
            입력은 자동으로 거절됩니다. 남용 방지를 위해 접속 IP는 복원할 수 없는 형태로
            변환(해시)해 하루 이용 횟수 확인에만 사용하고 3일 안에 삭제합니다. 공개된 질문의
            삭제를 원하시면 해당 페이지 주소와 함께 소개 페이지의 연락처로 알려주시면 지체 없이 삭제합니다.
          </p>
        </section>
